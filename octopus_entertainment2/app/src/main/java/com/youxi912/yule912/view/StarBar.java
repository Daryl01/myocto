...
public class StarBar extends View {
    private int starDistance = 3; //星星间距
    private int starCount = 5;  //星星个数
    private int starSize=14;     //星星高度大小，星星一般正方形，宽度等于高度
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starFillBitmap = drawableToBitmap(ContextCompat.getDrawable(context, R.drawable.evaluation_full));
        mTypedArray.recycle();
