package com.youxi912.yule912.live.liveStreaming;
...
import com.youxi912.yule912.live.util.network.NetworkMonitor;
import com.youxi912.yule912.live.util.network.NetworkUtils;
import com.youxi912.yule912.live.widget.MixAudioDialog;
import com.youxi912.yule912.live.widget.MixAudioLayout;
import com.youxi912.yule912.live.widget.NetWorkInfoDialog;
...
//        }
    ...
    private void handleMessageInMainThread(int msg, Object object) {
        switch (msg) {
            ...
            {
                boolean cameraId = (boolean) object;//切换之后的camera id
                break;
            }
