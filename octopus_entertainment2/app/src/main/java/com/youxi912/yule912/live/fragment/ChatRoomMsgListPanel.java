...
import com.youxi912.yule912.live.MsgAdapter;
import com.youxi912.yule912.live.TAdapterDelegate;
...
import com.youxi912.yule912.live.nim.viewholder.ChatRoomMsgViewHolderFactory;
...
public class ChatRoomMsgListPanel implements TAdapterDelegate {
    ...
    public void onIncomingMessage(List<ChatRoomMessage> messages) {
        ...
        for (ChatRoomMessage message : messages) {
            //点赞 与 礼物 信息不显示在聊天列表
            if(message!=null
//                    && (message.getAttachment() instanceof LikeAttachment || message.getAttachment() instanceof GiftAttachment)
                    ){
